:: #####################################################################################
:: # [new-project-template] - Windows - Docker-compose - Start Production containers   #
:: #####################################################################################
...
TITLE [new-project-template] Containers - Rebuild the Production container set.
...
ECHO.
ECHO -----------------------------------------------------
ECHO prod Project Template containers successfully started.
ECHO -----------------------------------------------------
